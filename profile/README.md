...
Landing Page ───────► App Download / Link Hub
...
- Link Hub: https://go.snaplink.run
- GitHub Organization: https://github.com/REVEDE-SNAPLINK

## Repository Structure

상세 구현은 각 repository에서 관리합니다.

- Mobile App: [SNAPLINK_FRONT](https://github.com/REVEDE-SNAPLINK/SNAPLINK_FRONT)
- Landing Page: [SNAPLINK_WEB](https://github.com/REVEDE-SNAPLINK/SNAPLINK_WEB)
- Admin Console: [SNAPLINK_ADMIN](https://github.com/REVEDE-SNAPLINK/SNAPLINK_ADMIN)
- Image Agent: [SNAPLINK_IMAGE_AGENT](https://github.com/REVEDE-SNAPLINK/SNAPLINK_IMAGE_AGENT)
- Backend: [SNAPLINK_BACK](https://github.com/REVEDE-SNAPLINK/SNAPLINK_BACK)
